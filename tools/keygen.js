#!/usr/bin/env node
//
// Float Finder — License Key Generator  (DEVELOPER TOOL — keep private)
//
// Usage:
...
function setup() {
  if (fs.existsSync(PRIVATE_KEY_PATH)) {
    ...
    console.log('Your PUBLIC KEY (paste this into main.js):\n');
    console.log(pubKey);
    return;
  }
...
if (!arg || arg === '--help') {
  console.log('Float Finder — License Key Generator\n');
  console.log('Usage:');
